...
import type { FitnessGoal } from "@/types/firestore";
                ...
                <div className="mb-6 flex flex-col items-center gap-3">
                    ...
                    <div className="text-center">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Start your fitness journey with GymRat AI
                        </p>
                    </div>
                </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {GOALS.map(({ value, label }) => (
                                    <button
                                        ...
                                        className={`rounded-full px-3 py-1.5 text-xs font-medium transition-all duration-200 ${selectedGoals.includes(value)
